...
public class MainActivity extends ActionBarActivity {
            ...
            public void onReceive(Context context, Intent intent) {
                switch (intent.getAction()) {
                    case Globals.LOG_IN_SUCCESS:
                        ...
                        break;
                    case Globals.LOG_IN_FAILURE:
                        showProgressBar(false);

                        String errorMessage = "";
                        switch ( intent.getIntExtra(Globals.EXTRA_ERR, -1) ) {
                            case 4:
    ...
    protected void onResume() {
        ...
        intentFilter.addAction(Globals.LOG_IN_SUCCESS);
        intentFilter.addAction(Globals.LOG_IN_FAILURE);
        intentFilter.addAction(Globals.EVENTS_UPDATED);
